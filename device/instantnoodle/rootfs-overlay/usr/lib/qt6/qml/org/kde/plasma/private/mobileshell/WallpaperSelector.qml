...
Controls.Drawer {
    ...
    FileDialog {
        ...
        title: i18n("Choose a wallpaper")
        options: FileDialog.DontUseNativeDialog
        currentFolder: StandardPaths.standardLocations(StandardPaths.PicturesLocation)[0]
        nameFilters: [i18n("Images (*.jpg *.jpeg *.png *.webp *.avif *.heif *.heic)")]
        onAccepted: {
            WallpaperImagePlugin.WallpaperPlugin.setHomescreenWallpaper(selectedFile);
