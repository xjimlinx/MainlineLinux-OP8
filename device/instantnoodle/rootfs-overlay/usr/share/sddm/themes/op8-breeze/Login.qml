...
SessionManagementScreen {
    ...
    // On a phone there is no physical keyboard. Ask Main.qml to open the
    // Qt Virtual Keyboard whenever the first editable control receives focus.
    signal requestVirtualKeyboard()
    ...
    function focusFirstVisibleFormControl() {
        ...
        if (nextControl === userNameInput || nextControl === passwordBox)
            Qt.callLater(requestVirtualKeyboard);
    }
