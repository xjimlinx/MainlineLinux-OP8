...
Item {
    ...
    MouseArea {
        ...
        // A phone normally has no physical keyboard.  Breeze only exposes a
        // footer button by default; open the panel once the greeter and its
        // focused password field have finished loading.
        Timer {
            id: op8KeyboardAutoShow
            interval: 250
            running: true
            repeat: true
            onTriggered: {
        ...
        RowLayout {
            id: footer
            anchors {
                // Keep the keyboard/session controls reachable when the
                // virtual keyboard occupies the bottom of the phone display.
                bottom: inputPanel.keyboardActive ? inputPanel.top : parent.bottom
                left: parent.left
                right: parent.right
